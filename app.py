...
with tab1:
    ...
    with col_c1:
        ingresos_globales_num = st.number_input("Ingreso total gravado,no gravado y exento:", min_value=0.0, step=10000.0, format="%.2f", help="Determina el tamaño del contribuyente y su alícuota.")
    with col_c2:
